...
class M_rekap extends CI_Model
{
    ...
    public function rekapDokter()
    {
        ...
        $this->db->select('(
                    (SUM(CASE WHEN data_fix.kd_dpjp = "LAB" OR data_fix.kd_dpjp = "LAB PA" OR data_fix.kd_dpjp = "FOTO" OR data_fix.kd_dpjp = "USG" OR data_fix.kd_dpjp = "RAD KONTRAS" OR data_fix.kd_dpjp = "CT - SCAN" OR data_fix.kd_dpjp = "MRI" OR data_fix.kd_dpjp = "KONSUL" OR data_fix.kd_dpjp = "GIZI" OR data_fix.kd_dpjp = "CT - SCAN RJ" OR data_fix.kd_dpjp = "MRI RJ" OR data_fix.kd_dpjp = "USG RJ" THEN ' . $this->hitungPenunjang2() . ' ELSE 0 END) +
                    SUM(CASE WHEN data_fix.kd_dpjp = "jasa operasi" THEN ' . $this->hitungJasaOperator2() . ' ELSE 0 END) +
                    SUM(CASE WHEN data_fix.kd_dpjp = "jasa anestesi" THEN ' . $this->hitungJasaAnestesi2() . ' ELSE 0 END) +
                    SUM(CASE WHEN data_fix.kd_dpjp = "dpjp_utama" THEN ' . $this->hitungJasaDpjpUtama2() . ' ELSE 0 END) +
        ...
        $this->db->select('SUM(CASE WHEN data_fix.kd_dpjp = "LAB" OR data_fix.kd_dpjp = "LAB PA" OR data_fix.kd_dpjp = "FOTO" OR data_fix.kd_dpjp = "USG" OR data_fix.kd_dpjp = "RAD KONTRAS" OR data_fix.kd_dpjp = "CT - SCAN" OR data_fix.kd_dpjp = "MRI" OR data_fix.kd_dpjp = "KONSUL" OR data_fix.kd_dpjp = "GIZI" OR data_fix.kd_dpjp = "CT - SCAN RJ" OR data_fix.kd_dpjp = "MRI RJ" OR data_fix.kd_dpjp = "USG RJ" THEN ' . $this->hitungPenunjang2() . ' ELSE 0 END) +
                    ...
                    SUM(CASE WHEN data_fix.kd_dpjp = "jasa anestesi" THEN ' . $this->hitungJasaAnestesi2() . ' ELSE 0 END) +
                    SUM(CASE WHEN data_fix.kd_dpjp = "dpjp_utama" THEN ' . $this->hitungJasaDpjpUtama2() . ' ELSE 0 END) +
                    SUM(CASE WHEN data_fix.kd_dpjp = "dpjp2_dst" THEN ' . $this->hitungJasaDpjp2Dst2() . ' ELSE 0 END) AS jasa_belum_dikurangi', false);
        $this->db->select('
                    CASE 
                        WHEN data_fix.dokter != "Dokter Umum" 
                        THEN ((' . $this->total20persen() . ') / (' . $this->jumlah_dokterspesialis() . ')) + 
                             (
                                (SUM(CASE WHEN data_fix.kd_dpjp = "LAB" OR data_fix.kd_dpjp = "LAB PA" OR data_fix.kd_dpjp = "FOTO" OR data_fix.kd_dpjp = "USG" OR data_fix.kd_dpjp = "RAD KONTRAS" OR data_fix.kd_dpjp = "CT - SCAN" OR data_fix.kd_dpjp = "MRI" OR data_fix.kd_dpjp = "KONSUL" OR data_fix.kd_dpjp = "GIZI" OR data_fix.kd_dpjp = "CT - SCAN RJ" OR data_fix.kd_dpjp = "MRI RJ" OR data_fix.kd_dpjp = "USG RJ"
    ...
    private function hitungTotalJasa20Persen()
    {
        return '(
            SUM(CASE WHEN data_fix.kd_dpjp = "LAB" OR data_fix.kd_dpjp = "LAB PA" OR data_fix.kd_dpjp = "FOTO" 
                     ...
                     OR data_fix.kd_dpjp = "MRI" OR data_fix.kd_dpjp = "KONSUL" OR data_fix.kd_dpjp = "GIZI" OR data_fix.kd_dpjp = "CT - SCAN RJ" OR data_fix.kd_dpjp = "MRI RJ" OR data_fix.kd_dpjp = "USG RJ"
                     THEN ' . $this->hitungPenunjang2() . ' ELSE 0 END) + 
            SUM(CASE WHEN data_fix.kd_dpjp = "jasa operasi" THEN ' . $this->hitungJasaOperator2() . ' ELSE 0 END) + 
            SUM(CASE WHEN data_fix.kd_dpjp = "jasa anestesi" THEN ' . $this->hitungJasaAnestesi2() . ' ELSE 0 END) + 
            SUM(CASE WHEN data_fix.kd_dpjp = "dpjp_utama" THEN ' . $this->hitungJasaDpjpUtama2() . ' ELSE 0 END) + 
    ...
    {
        $query = $this->db->query("
            SELECT COUNT(DISTINCT dokter) AS jumlah_dokter
            FROM data_fix
