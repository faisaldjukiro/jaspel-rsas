...
class HistoryController extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['jasa_dokter'] = $this->db->order_by('id_jasa', 'DESC')
								->get_where('tb_jasa_dokter_spesialis', ['kd_peg' => $this->session->userdata('username')])
								->result_array();
		$this->load->view('pages/hasil/dokter', $data);
